...
<body>
    ...
    <p class = "intro">Beautiful Soup makes web scarping easy</p>
    <div id="content">
    <p>Here are some links</p>
    <a href="http://example.come/page1">Link1</a>
    <a href="http://example.come/page2">Link2</a>
    <a href="http://example.come/page3">Link2</a>
    </div>
</body>
</html>
"""
